...
$case = 2; //1.txt 获取个人实名认证地址 2 查询个人刷脸状态
switch($case){
    case 1:
        ...
        CommonHelper::printMsg('*****获取个人实名认证地址（电子签名场景专用），获取个人实名认证地址*****');
        ...
        $indivInfo = []; //个人基本信息
        $repeatIdentity = true;
        $res = $individualAuthHelper->web($accountId,$authType,$contextInfo,$indivInfo,$repeatIdentity);
        if($res['code'] != 0){
